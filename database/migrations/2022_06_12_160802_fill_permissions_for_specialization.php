...
class FillPermissionsForSpecialization extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpecialization constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.specialization.show',
            'admin.specialization.edit',
            'admin.specialization.delete',
            'admin.specialization.bulk-delete',
        ]);
