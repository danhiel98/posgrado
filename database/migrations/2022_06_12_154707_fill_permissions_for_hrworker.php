...
class FillPermissionsForHrworker extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHrworker constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.hrworker',
            'admin.hrworker.index',
            'admin.hrworker.create',
            'admin.hrworker.show',
            'admin.hrworker.edit',
            'admin.hrworker.delete',
            'admin.hrworker.bulk-delete',
        ]);
