                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'result'">{{ trans('admin.revision.columns.result') }}</th>
                                        <th is='sortable' :column="'comments'">{{ trans('admin.revision.columns.comments') }}</th>
                                        <th is='sortable' :column="'hrworker_id'">{{ trans('admin.revision.columns.hrworker_id') }}</th>
                                        <th is='sortable' :column="'request_id'">{{ trans('admin.revision.columns.request_id') }}</th>
